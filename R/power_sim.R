...
#'
#' @return dataframe; a dataframe containing the results of the evaluation procedure and the design specification
...
#' - sig[_robust]: logical, if the estimate coefficient (estimate) is significant (alpha = 0.05).
