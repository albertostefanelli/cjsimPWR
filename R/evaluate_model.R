...
#' @description Power analysis and error-rate calculations of the conjoint process of profile selection.
#' @param input list; a list containing (a) a dataframe with the simulated data in long format generated by sim_to_long() and (b) a list of inputs that represents the design specifications.
